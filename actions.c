...
struct _host_info_single hosts[] = {
    {23300, 66600, "H", 0},   {66600, 99900, "H2", 1},
    {66600, 99900, "H3", 2},  {23300, 66600, "H4", 3},
    {66600, 99900, "H5", 4},  {23300, 66600, "H6", 5},
    {66600, 99900, "H7", 6},  {66600, 99900, "H8", 7},
    {23300, 66600, "H9", 8},  {66600, 99900, "10", 9},
    {23300, 66600, "11", 10}, {66600, 99900, "12", 11},
    {66600, 99900, "13", 12}, {23300, 66600, "14", 13},
    {66600, 99900, "15", 14}, {23300, 66600, "16", 15},
    {66600, 99900, "17", 16}, {66600, 99900, "18", 17},
    {23300, 66600, "19", 18}, {66600, 99900, "20", 19},
    {66600, 99900, "21", 20}, {23300, 66600, "22", 21},
    {66600, 99900, "23", 22}, {23300, 66600, "24", 23},
    {66600, 99900, "25", 24}, {23300, 66600, "26", 25},
    {66600, 99900, "27", 26}, {66600, 99900, "28", 27},
    {23300, 66600, "29", 28}, {66600, 99900, "30", 29}};

struct _host_info_single *get_hosts() {
    return hosts;
}

int get_hosts_count() { return sizeof(hosts) / sizeof(hosts[0]); }
...
void send_page_data(PAGE page) {
    ...
    case PAGE_BASIC_INFO:
        request_update_basic_info("K3-LEDE", "A-Any", "r3921+6",
                                  "23:33:66:66:99:99");
        break;
    case PAGE_PORTS:
        do {
