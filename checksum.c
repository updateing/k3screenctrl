const unsigned short XLAT_TABLE[] = {
    ...
    0x4084, 0x50a5, 0x60c6, 0x70e7, 0x8108,
...
int main() {
    const unsigned char data[] = {0x30, 0x06, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
    printf("%hx\n", checksum(data, sizeof(data))); // Should be d453
}